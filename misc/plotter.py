...
class Plotter:
  ...
  def DrawPile(self):
    try:
      ...
      print("[tarantula::Plotter::DrawPile] error: wrong format")
      exit()
  ...
  def DrawGraph(self):
    try:
      ...
      print("[tarantula::Plotter::DrawGraph] error: wrong format")
      exit()
    ...
    for component in data:
      ...
      for edge in graph["edges"]:
        ...
        pyplot.plot([x[0], y[0]], [x[1], y[1]], '-', color = scpb[1])

      for node in graph["nodes"]:
        x = graph["nodes"][node]
        pyplot.plot(x[0], x[1], '.', color = scpb[2], markersize = 15)
    ...
    try:
      ...
      try:
        ...
        try:
          ...
          print("[tarantula::Plotter::DrawHeatmap] error: wrong format")
          exit()
...
if __name__ == "__main__":
  parser = argparse.ArgumentParser(
    description = "Plotter is a tool for drawing heatmaps, graphs and pile-o-grams",
    formatter_class = argparse.ArgumentDefaultsHelpFormatter)
  parser.add_argument("mode",
    help = "draw either [heatmap], [graph] or [pile]-o-grams")
  parser.add_argument("path",
    help = "heatmap: SAM / 2x PAF / npy | graph: JSON | pile: JSON",
    nargs = "*")
